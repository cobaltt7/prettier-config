...
## [v3.4.5](https://www.npmjs.com/package/@redguy12/prettier-config/v/3.4.5) (2026-05-19)

- Treat `.css` imports as side-effect free by default
- Don't condense Markdown text on the line right after a code block
- Bump dependencies
